...
function checkIfDivBySeven(NumArr) {
  ...
  if (IsDivBySeven) {
    alert("The array contains an element that can be divided by 7.");
  } else {
...
function checkForDuplicates(NumArr) {
  ...
  if (NumArr.length > 0) {
    alert("The array contains at least one duplicate.");
  } else {
    alert("The array DOES NOT contain at least one duplicate.");
  }
}
